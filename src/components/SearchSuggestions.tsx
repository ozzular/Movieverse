  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        className={`absolute top-full left-0 right-0 mt-2 bg-black/90 backdrop-blur-lg border border-white/20 rounded-xl z-50 max-h-96 overflow-y-auto ${className}`}
      >
