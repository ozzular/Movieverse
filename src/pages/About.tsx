      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
            An educational graduation project showcasing modern web development
            with React, TypeScript, and cutting-edge UI/UX design
          </p>
        </div>
        ...
        <div className="glass-effect mb-16 p-8 rounded-xl">
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-gray-300 leading-relaxed">
              MovieVerse is a comprehensive movie discovery platform built as a
              graduation project to demonstrate proficiency in modern web
              development technologies, API integration, responsive design, and
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          ...
          <div className="glass-effect p-6 rounded-xl text-center group hover-scale hover-lift">
            ...
            <p className="text-gray-300">
              Real-time data from TMDB and JustWatch APIs
            </p>
          </div>
          ...
          <div className="glass-effect p-6 rounded-xl text-center group hover-scale hover-lift">
            ...
            <p className="text-gray-300">
              Modern UI with backdrop blur and transparency effects
            </p>
          </div>
          ...
          <div className="glass-effect p-6 rounded-xl text-center group hover-scale hover-lift">
            ...
            <p className="text-gray-300">
              Lazy loading, code splitting, and optimized bundles
            </p>
          </div>
