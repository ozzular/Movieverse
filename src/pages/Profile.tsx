...
import { Settings, Sun, Moon, Globe, User, Bell, Shield, Palette, Monitor, MapPin, Sliders, Save, Edit, Languages } from 'lucide-react'
import { useTranslation } from 'react-i18next'
import { useTheme } from '../contexts/ThemeContext'
import { useRegion } from '../contexts/RegionContext'
import { getAvailableRegions, getRegionalContent } from '../services/geolocation'

const SettingsPage = () => {
  const { t, i18n } = useTranslation()
  const { themeMode, setThemeMode, currentTheme, sunriseTime, sunsetTime } = useTheme()
  const { showLocationModal, setShowLocationModal, refreshContent } = useRegion()
  ...
  const handleRegionChange = (region: string) => {
    ...
    localStorage.setItem('movieverse-region', region)
    refreshContent()
  }
    ...
    <div className="min-h-screen bg-gradient-to-b from-black via-gray-900 to-black pt-20">
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-300">Customize your MovieVerse experience</p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
            ...
            <div className="space-y-6">
              ...
              {themeMode === 'auto' && sunriseTime && sunsetTime && (
                <div className="glass-card p-4 rounded-lg bg-white/5">
                  <h3 className="text-white font-semibold mb-2">Day/Night Schedule</h3>
          ...
          <div className="glass-card p-8 rounded-xl">
            ...
            <div className="space-y-6">
              <div>
                <label className="block text-lg font-semibold text-white mb-3">Region for Trending Content</label>
                <select
                ...
                >
                  {availableRegions.map((region: { code: string; name: string }) => (
          ...
          <div className="glass-card p-8 rounded-xl">
            ...
            <div className="space-y-6">
              <div>
                <label className="block text-lg font-semibold text-white mb-3">Application Language</label>
                  ...
                  {languages.map(language => (
                    <button
                      ...
                      className={`glass-card p-4 rounded-lg flex items-center justify-center transition-all hover:scale-105 ${
                        selectedLanguage === language.code ? 'ring-2 ring-white/50' : ''
                      }`}
                    >
              ...
              <div className="text-sm text-gray-400">
                <p>Note: Language changes require a page refresh to take full effect.</p>
              </div>
            </div>
          </div>
          ...
          <div className="glass-card p-8 rounded-xl">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="text-white font-semibold">Auto-play Trailers</h3>
                  <p className="text-gray-400 text-sm">Automatically play trailers when available</p>
                </div>
        ...
        <div className="text-center mt-12">
          <button className="glass-card px-8 py-4 rounded-xl flex items-center space-x-2 hover:bg-white/10 transition-colors mx-auto">
            ...
            <span className="text-white font-semibold text-lg">Save Settings</span>
          </button>
        </div>
      </div>
    </div>
