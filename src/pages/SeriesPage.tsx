  ...
  useEffect(() => {
    const fetchSeriesData = async () => {
      try {
        ...
        const errorMessage =
          err instanceof Error ? err.message : "Failed to fetch TV series";
    ...
    try {
      ...
      const errorMessage =
        err instanceof Error
          ? err.message
          : `Failed to fetch TV shows: ${category}`;
        ...
        <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden">
          {trendingSeries.length > 0 && (
            <div
              ...
              style={{
                backgroundImage: `url(${
                  trendingSeries[0]?.backdrop_path
          ...
          <div className="relative z-10 text-center w-full px-4">
            ...
            <p className="text-xl text-gray-300 leading-relaxed">
              Discover the best TV series, dramas, comedies, and more from
              around the world. From critically acclaimed shows to binge-worthy
              series.
            </p>
          </div>
        </section>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
              {[
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      `/search?q=tv+${genre.name.toLowerCase().replace("&", "").replace(" ", "+")}`,
                    )
                  }
                ...
                >
                  ...
                  <p className="text-[var(--text-secondary)] text-sm relative z-10">
                    Explore {genre.name.toLowerCase()} series
                  </p>
                </button>
              ))}
            </div>
