...
export const PROVIDER_LOGOS: Record<string, string> = {
  'Netflix': 'https://cdn.jsdelivr.net/gh/JustWatch/streaming-logos@main/logos/netflix/logo_2.svg',
  'Amazon Prime Video': 'https://cdn.jsdelivr.net/gh/JustWatch/streaming-logos@main/logos/prime_video/logo_2.svg',
  'Prime Video': 'https://cdn.jsdelivr.net/gh/JustWatch/streaming-logos@main/logos/prime_video/logo_2.svg',
  'Hulu': 'https://cdn.jsdelivr.net/gh/JustWatch/streaming-logos@main/logos/hulu/logo_2.svg',
  'Disney Plus': 'https://cdn.jsdelivr.net/gh/JustWatch/streaming-logos@main/logos/disney_plus/logo_2.svg',
  'Disney+': 'https://cdn.jsdelivr.net/gh/JustWatch/streaming-logos@main/logos/disney_plus/logo_2.svg',
  'Apple TV Plus': 'https://cdn.jsdelivr.net/gh/JustWatch/streaming-logos@main/logos/apple_tv_plus/logo_2.svg',
  'Apple TV+': 'https://cdn.jsdelivr.net/gh/JustWatch/streaming-logos@main/logos/apple_tv_plus/logo_2.svg',
  'HBO Max': 'https://cdn.jsdelivr.net/gh/JustWatch/streaming-logos@main/logos/hbo_max/logo_2.svg',
  'Max': 'https://cdn.jsdelivr.net/gh/JustWatch/streaming-logos@main/logos/hbo_max/logo_2.svg',
  'Peacock': 'https://cdn.jsdelivr.net/gh/JustWatch/streaming-logos@main/logos/peacock/logo_2.svg',
  'Paramount Plus': 'https://cdn.jsdelivr.net/gh/JustWatch/streaming-logos@main/logos/paramount_plus/logo_2.svg',
  'Paramount+': 'https://cdn.jsdelivr.net/gh/JustWatch/streaming-logos@main/logos/paramount_plus/logo_2.svg',
}

// Cache for API responses (simple in-memory cache)
const cache = new Map<string, { data: StreamingProvider[], timestamp: number }>()
...
class JustWatchAPI {
  ...
  async getStreamingProviders(movieTitle: string, releaseYear?: number): Promise<StreamingProvider[]> {
    ...
    try {
      ...
      const searchResults = await this.request(`/search/title?movie=${encodeURIComponent(movieTitle)}&country=US`)
      ...
      const availability = await this.request(`/get/basic?imdb_id=${movie.imdb_id}&country=US`)
